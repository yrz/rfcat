      ...
      0000E4 E4               [12]  996 	clr	a
      0000E5 F5 08            [12]  997 	mov	_dma_channels,a
      0000E7 F5 09            [12]  998 	mov	(_dma_channels + 1),a
                                    999 ;--------------------------------------------------------
                                   1000 ; Home
                                   1001 ;--------------------------------------------------------
                                   1002 	.area HOME    (CODE)
      ...
      00193C 7E 96            [12] 1025 	mov	r6,#_dma_configs
      00193E 7F F2            [12] 1026 	mov	r7,#(_dma_configs >> 8)
      001940 8F D5            [24] 1027 	mov	_DMA0CFGH,r7
                                   1028 ;	chipcon_dma.c:34: DMA0CFGL = ((u16)(&dma_configs[0]))&0xff;
      001942 7E 96            [12] 1029 	mov	r6,#_dma_configs
      001944 7F F2            [12] 1030 	mov	r7,#(_dma_configs >> 8)
      001946 8E D4            [24] 1031 	mov	_DMA0CFGL,r6
                                   1032 ;	chipcon_dma.c:38: DMA1CFGH = ((u16)(&dma_configs[1]))>>8;
      001948 7E 9E            [12] 1033 	mov	r6,#(_dma_configs + 0x0008)
      00194A 7F F2            [12] 1034 	mov	r7,#((_dma_configs + 0x0008) >> 8)
      00194C 8F D3            [24] 1035 	mov	_DMA1CFGH,r7
                                   1036 ;	chipcon_dma.c:39: DMA1CFGL = ((u16)(&dma_configs[1]))&0xff;
      00194E 7E 9E            [12] 1037 	mov	r6,#(_dma_configs + 0x0008)
      001950 7F F2            [12] 1038 	mov	r7,#((_dma_configs + 0x0008) >> 8)
      001952 7F 00            [12] 1039 	mov	r7,#0x00
      001954 8E D2            [24] 1040 	mov	_DMA1CFGL,r6
      ...
      001956 8F 0F            [24] 1043 	mov	_memset_PARM_2,r7
      001958 75 10 18         [24] 1044 	mov	_memset_PARM_3,#0x18
                                   1045 ;	1-genFromRTrack replaced	mov	(_memset_PARM_3 + 1),#0x00
      00195B 8F 11            [24] 1046 	mov	(_memset_PARM_3 + 1),r7
      00195D 90 F2 96         [24] 1047 	mov	dptr,#_dma_configs
      001960 75 F0 00         [24] 1048 	mov	b,#0x00
      001963 02 2A 3B         [24] 1049 	ljmp	_memset
                                   1050 ;------------------------------------------------------------
      ...
      001966 74 03            [12] 1059 	mov	a,#0x03
      001968 B5 08 06         [24] 1060 	cjne	a,_dma_channels,00109$
      00196B E4               [12] 1061 	clr	a
      00196C B5 09 02         [24] 1062 	cjne	a,(_dma_channels + 1),00109$
      00196F 80 02            [24] 1063 	sjmp	00110$
      001971                       1064 00109$:
      001971 80 04            [24] 1065 	sjmp	00102$
      001973                       1066 00110$:
                                   1067 ;	chipcon_dma.c:49: return 0xff;
      001973 75 82 FF         [24] 1068 	mov	dpl,#0xFF
      001976 22               [24] 1069 	ret
      001977                       1070 00102$:
                                   1071 ;	chipcon_dma.c:51: return dma_channels++;
      001977 AE 08            [24] 1072 	mov	r6,_dma_channels
      001979 AF 09            [24] 1073 	mov	r7,(_dma_channels + 1)
      00197B 05 08            [12] 1074 	inc	_dma_channels
      00197D E4               [12] 1075 	clr	a
      00197E B5 08 02         [24] 1076 	cjne	a,_dma_channels,00111$
      001981 05 09            [12] 1077 	inc	(_dma_channels + 1)
      001983                       1078 00111$:
      001983 8E 82            [24] 1079 	mov	dpl,r6
      001985 22               [24] 1080 	ret
                                   1081 	.area CSEG    (CODE)
